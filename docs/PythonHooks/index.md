...
- [`delete_thread_replies_hook`](./delete-thread-replies-hook.md)
- [`delete_thread_replies_input_model_hook`](./delete-thread-replies-input-model-hook.md)
- [`delete_thread_replies_input_replies_hook`](./delete-thread-replies-input-replies-hook.md)
- [`delete_thread_replies_input_thread_hook`](./delete-thread-replies-input-thread-hook.md)
