...
Misago function that saves a new poll, updates the thread instance, and creates a new thread event object. Used only when the poll is started after the thread has already been started.
