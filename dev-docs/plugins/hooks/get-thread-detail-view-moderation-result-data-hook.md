...
```python
def get_thread_detail_view_moderation_result_data_action(request: HttpRequest, thread: Thread) -> dict:
    ...
```

Misago function used to get the template context data for the moderation result in the thread detail view.
