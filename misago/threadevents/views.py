...
class EventHideView(EventView):
    success_message = pgettext_lazy(
        "thread thread_event hide success message", "Thread event hidden"
    )
    ...
    def raise_permission_error(self):
        raise PermissionDenied(
            pgettext(
                "thread thread_event hide permission error",
...
class EventUnhideView(EventView):
    success_message = pgettext_lazy(
        "thread thread_event unhide success message", "Thread event unhidden"
    )
    ...
    def raise_permission_error(self):
        raise PermissionDenied(
            pgettext(
                "thread thread_event unhide permission error",
...
class EventDeleteView:
    ...
    success_message = pgettext_lazy(
        "thread thread_event deleted", "Thread event deleted"
    )
    ...
    def raise_permission_error(self):
        raise PermissionDenied(
            pgettext(
                "thread thread_event delete permission error",
