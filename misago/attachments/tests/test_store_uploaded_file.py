...
def test_store_uploaded_file_stores_text_file(user, dynamic_settings, text_file):
...
def test_store_uploaded_file_stores_image_file(user, dynamic_settings, image_small):
