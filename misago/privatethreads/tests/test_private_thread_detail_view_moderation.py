...
def test_private_thread_detail_view_post_moderation_action_shows_error_to_user(
    thread_reply_factory, user_client, user_private_thread
):
    reply = thread_reply_factory(user_private_thread, poster="DeletedUser")
...
def test_private_thread_detail_view_post_moderation_action_shows_error_to_user_in_htmx(
    thread_reply_factory, user_client, user_private_thread
):
    reply = thread_reply_factory(user_private_thread, poster="DeletedUser")
...
def test_private_thread_detail_view_post_moderation_action_shows_error_for_invalid_moderation_action(
    thread_reply_factory, moderator_client, user_private_thread
):
    reply = thread_reply_factory(user_private_thread, poster="DeletedUser")
...
def test_private_thread_detail_view_post_moderation_action_shows_error_for_invalid_moderation_action_in_htmx(
    thread_reply_factory, moderator_client, user_private_thread
):
    reply = thread_reply_factory(user_private_thread, poster="DeletedUser")
...
def test_private_thread_detail_view_post_moderation_action_shows_error_for_empty_moderation_action(
    thread_reply_factory, moderator_client, user_private_thread
):
    reply = thread_reply_factory(user_private_thread, poster="DeletedUser")
...
def test_private_thread_detail_view_post_moderation_action_shows_error_for_empty_moderation_action_in_htmx(
    thread_reply_factory, moderator_client, user_private_thread
):
    reply = thread_reply_factory(user_private_thread, poster="DeletedUser")
...
def test_private_thread_detail_view_post_moderation_action_shows_error_for_missing_post_selection(
    moderator_client, user_private_thread
):
    response = moderator_client.post(
        reverse(
...
def test_private_thread_detail_view_post_moderation_action_shows_error_for_missing_post_selection_in_htmx(
    moderator_client, user_private_thread
):
    response = moderator_client.post(
        reverse(
...
def test_private_thread_detail_view_post_moderation_action_shows_error_for_empty_post_selection(
    moderator_client, user_private_thread
):
    response = moderator_client.post(
        reverse(
...
def test_private_thread_detail_view_post_moderation_action_shows_error_for_empty_post_selection_in_htmx(
    moderator_client, user_private_thread
):
    response = moderator_client.post(
        reverse(
...
def test_private_thread_detail_view_post_moderation_action_shows_error_for_invalid_post_selection(
    moderator_client, user_private_thread
):
    response = moderator_client.post(
        reverse(
...
def test_private_thread_detail_view_post_moderation_action_shows_error_for_invalid_post_selection_in_htmx(
    moderator_client, user_private_thread
):
    response = moderator_client.post(
        reverse(
...
def test_private_thread_detail_view_post_moderation_action_shows_error_for_not_existing_post_id_in_selection(
    moderator_client, user_private_thread
):
    response = moderator_client.post(
        reverse(
        ...
        {"post_moderation": "unlock", "post": user_private_thread.last_post_id + 1},
    )
    assert_contains(response, "No valid posts selected.")


def test_private_thread_detail_view_post_moderation_action_shows_error_for_not_existing_post_id_in_selection_in_htmx(
    moderator_client, user_private_thread
):
    response = moderator_client.post(
        reverse(
...
def test_private_thread_detail_view_post_moderation_action_shows_error_for_other_thread_post_id_in_selection(
    moderator_client, user_private_thread, other_user_private_thread
):
    response = moderator_client.post(
        reverse(
        ...
        {
            "post_moderation": "unlock",
            "post": other_user_private_thread.last_post_id,
        },
    )
    assert_contains(response, "No valid posts selected.")


def test_private_thread_detail_view_post_moderation_action_shows_error_for_other_thread_post_id_in_selection_in_htmx(
    moderator_client, user_private_thread, other_user_private_thread
):
    response = moderator_client.post(
        reverse(
