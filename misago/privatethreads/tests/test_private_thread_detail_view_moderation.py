...
def test_private_thread_list_view_shows_error_for_invalid_thread_moderation_action(
    moderator_client, user_private_thread
):
    response = moderator_client.post(
        reverse(
...
def test_private_thread_list_view_shows_error_for_invalid_thread_moderation_action_in_htmx(
    moderator_client, user_private_thread
):
    response = moderator_client.post(
        reverse(
...
def test_private_thread_list_view_shows_error_for_empty_thread_moderation_action(
    moderator_client, user_private_thread
):
    response = moderator_client.post(
        reverse(
...
def test_private_thread_list_view_shows_error_for_empty_thread_moderation_action_in_htmx(
    moderator_client, user_private_thread
):
    response = moderator_client.post(
        reverse(
