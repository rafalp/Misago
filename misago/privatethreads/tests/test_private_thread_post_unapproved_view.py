...
def test_private_thread_post_unapproved_view_returns_error_403_if_user_cant_use_private_threads(
...
def test_private_thread_post_unapproved_view_returns_error_if_thread_is_public(
    user_client, thread
):
    response = user_client.get(
        reverse(
