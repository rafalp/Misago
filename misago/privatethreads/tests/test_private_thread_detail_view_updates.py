...
def test_private_thread_detail_view_doesnt_show_thread_event_to_user_if_thread_flag_is_not_set(
    user_client, user, other_user_private_thread
):
    thread_event = create_test_thread_event(other_user_private_thread, user)
...
def test_private_thread_detail_view_shows_deleted_user_thread_event_to_user(
    ...
    thread_event = create_test_thread_event(other_user_private_thread, "DeletedUser")
...
def test_private_thread_detail_view_shows_hide_thread_event_button_to_private_threads_moderator(
    user_client, user, other_user_private_thread
):
    Moderator.objects.create(
        user=user,
...
def test_private_thread_detail_view_shows_hide_thread_event_button_to_global_moderator(
    moderator_client, user, other_user_private_thread
):
    thread_event = create_test_thread_event(other_user_private_thread, user)
...
def test_private_thread_detail_view_shows_unhide_thread_event_button_to_category_moderator(
    user_client, user, other_user_private_thread
):
    Moderator.objects.create(
        user=user,
...
def test_private_thread_detail_view_shows_unhide_thread_event_button_to_global_moderator(
    moderator_client, user, other_user_private_thread
):
    thread_event = create_test_thread_event(other_user_private_thread, user)
    thread_event.is_hidden = True
...
def test_private_thread_detail_view_doesnt_show_delete_thread_event_button_to_user(
    user_client, user, other_user_private_thread
):
    thread_event = create_test_thread_event(other_user_private_thread, user)
...
def test_private_thread_detail_view_shows_delete_thread_event_button_to_category_moderator(
    user_client, user, other_user_private_thread
):
    Moderator.objects.create(
        user=user,
...
def test_private_thread_detail_view_shows_delete_thread_event_button_to_global_moderator(
    moderator_client, user, other_user_private_thread
):
    thread_event = create_test_thread_event(other_user_private_thread, user)
...
def test_private_thread_detail_view_shows_thread_events_on_first_page(
    thread_reply_factory, user_client, user, other_user_private_thread
):
    first_page_thread_event = create_test_thread_event(other_user_private_thread, user)

    for _ in range(6):
        thread_reply_factory(other_user_private_thread)

    last_page_thread_event = create_test_thread_event(other_user_private_thread, user)
...
def test_private_thread_detail_view_shows_thread_events_on_second_page(
    thread_reply_factory, user_client, user, other_user_private_thread
):
    for _ in range(4):
        thread_reply_factory(other_user_private_thread)
    ...
    second_page_thread_event = create_test_thread_event(other_user_private_thread, user)
...
def test_private_thread_detail_view_shows_thread_events_on_last_page(
    thread_reply_factory, user_client, user, other_user_private_thread
):
    for _ in range(4):
        thread_reply_factory(other_user_private_thread)
...
def test_private_thread_detail_view_limits_displayed_thread_events_count(
    user_client, user, other_user_private_thread
):
    thread_events = []
    for _ in range(5):
        thread_events.append(create_test_thread_event(other_user_private_thread, user))
...
def test_private_thread_detail_view_displays_thread_event_with_other_category_context(
    ...
    create_moved_thread_event(other_user_private_thread, other_category, user)
...
def test_private_thread_detail_view_displays_thread_event_with_inaccessible_other_category_context(
...
def test_private_thread_detail_view_displays_thread_event_with_other_thread_context(
...
def test_private_thread_detail_view_displays_thread_event_with_inaccessible_other_thread_context(
    user_client, user, other_user_private_thread, other_thread
):
    create_split_posts_from_thread_event(
        other_user_private_thread, other_thread, actor=user
...
def test_private_thread_detail_view_displays_thread_event_with_user_context(
    user_client, user, other_user, other_user_private_thread
):
    create_added_member_thread_event(other_user_private_thread, other_user, user)
