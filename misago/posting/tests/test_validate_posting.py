...
def test_validate_posting_validates_new_thread(user_request, default_category):
    formset = get_thread_start_formset(user_request, default_category)
    state = ThreadStartState(user_request, default_category)
    assert validate_posting(formset, state)


def test_validate_posting_validates_new_private_thread(
...
def test_validate_posting_validates_new_thread_reply(user_request, other_user_thread):
    formset = get_thread_reply_formset(user_request, other_user_thread)
    state = ThreadReplyState(user_request, other_user_thread)
    assert validate_posting(formset, state)


def test_validate_posting_validates_new_private_thread_reply(
...
def test_validate_posting_validates_edited_thread(user_request, user_thread):
...
def test_validate_posting_validates_edited_private_thread(
    user_request, user_private_thread
):
...
def test_validate_posting_validates_edited_thread_post(user_request, user_thread):
    formset = get_thread_post_edit_formset(user_request, user_thread.first_post)
    state = ThreadPostEditState(user_request, user_thread.first_post)
    assert validate_posting(formset, state)


def test_validate_posting_validates_edited_private_thread_post(
    user_request, user_private_thread
):
