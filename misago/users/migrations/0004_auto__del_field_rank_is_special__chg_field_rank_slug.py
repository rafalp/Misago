...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Rank.is_special'
        db.delete_column(u'users_rank', 'is_special')


        # Changing field 'Rank.slug'
        db.alter_column(u'users_rank', 'slug', self.gf('django.db.models.fields.CharField')(default='-', max_length=255))

    def backwards(self, orm):
        # Adding field 'Rank.is_special'
        db.add_column(u'users_rank', 'is_special',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Rank.slug'
        db.alter_column(u'users_rank', 'slug', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
