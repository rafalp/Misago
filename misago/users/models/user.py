...
class User(AbstractBaseUser, PluginDataModel, PermissionsMixin):
    ...
    is_active_team_message = models.TextField(null=True, blank=True)
    ...
    avatar_lock_team_message = models.TextField(null=True, blank=True)
    ...
    signature_lock_team_message = models.TextField(null=True, blank=True)
