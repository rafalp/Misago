...
class PluginOutlet(Enum):
    ...
    THREADS_LIST_END = "On the threads page, under the list."
    ...
    CATEGORY_THREADS_LIST_END = "On the category threads page, under the list."

    PRIVATE_THREADS_LIST_START = "On the private threads page, above the list."
    PRIVATE_THREADS_LIST_END = "On the private threads page, under the list."
