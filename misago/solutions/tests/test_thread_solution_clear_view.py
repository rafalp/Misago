...
def test_thread_solution_clear_view_returns_error_404_if_user_has_no_category_permission(
    user_client, default_category, user_thread
):
    default_category.enable_solutions = True
    default_category.save()
...
def test_thread_solution_clear_view_returns_error_404_if_user_has_no_thread_permission(
    user_client, default_category, user_thread
):
    default_category.enable_solutions = True
    default_category.save()
...
def test_thread_solution_clear_view_returns_error_403_if_user_is_anonymous(
    ...
    assert_contains(response, "You can&#x27;t clear thread solutions.", status_code=403)


def test_thread_solution_clear_view_returns_error_404_thread_is_private(
