...
def test_thread_solution_lock_view_locks_thread_solution(
...
def test_thread_solution_lock_view_returns_redirect_to_solution(
    thread_reply_factory,
    moderator_client,
    moderator,
    user,
...
def test_thread_solution_lock_view_returns_redirect_to_next_url(
    thread_reply_factory,
    moderator_client,
    moderator,
    user,
...
def test_thread_solution_lock_view_returns_redirect_to_thread_for_invalid_next_url(
    thread_reply_factory,
    moderator_client,
    moderator,
    user,
...
def test_thread_solution_lock_view_does_nothing_if_thread_solution_is_locked(
    thread_reply_factory,
    moderator_client,
    moderator,
    user,
...
def test_thread_solution_lock_view_does_nothing_if_thread_has_no_solution(
