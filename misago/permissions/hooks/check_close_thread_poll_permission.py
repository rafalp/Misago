...
class CheckCloseThreadPollPermissionHookFilter(Protocol):
    """
...
class CheckCloseThreadPollPermissionHook(
    FilterHook[
        CheckCloseThreadPollPermissionHookAction,
        CheckCloseThreadPollPermissionHookFilter,
    ]
):
    """
    This hook allows plugins to replace or extend the permission check for the
    "can close thread poll" permission.
...
check_close_thread_poll_permission_hook = CheckCloseThreadPollPermissionHook()
