...
def test_check_change_thread_solution_permission_fails_for_anonymous_user_for_other_user_thread_in_category_with_disabled_solutions(
    ...
    guests_group.can_change_own_thread_solutions = PermissionValue.YES
    guests_group.save()
...
def test_check_change_thread_solution_permission_passes_for_global_moderator_without_permission_for_own_thread(
    ...
    moderators_group.can_change_own_thread_solutions = PermissionValue.NO
    moderators_group.save()
...
def test_check_change_thread_solution_permission_fails_for_user_with_never_permission_for_own_thread(
    thread_factory,
    thread_reply_factory,
    user_permissions_factory,
    user,
    ...
    members_group.can_change_own_thread_solutions = PermissionValue.NEVER
    members_group.save()
...
def test_check_change_thread_solution_permission_fails_for_anonymous_user_without_permission_for_other_user_thread(
    ...
    guests_group.can_change_own_thread_solutions = PermissionValue.NO
    guests_group.save()
...
def test_check_clear_thread_solution_permission_fails_for_anonymous_user_for_other_user_thread_in_category_with_disabled_solutions(
    ...
    guests_group.can_clear_own_thread_solutions = PermissionValue.YES
    guests_group.save()
...
def test_check_clear_thread_solution_permission_passes_for_global_moderator_without_permission_for_own_thread(
    ...
    moderators_group.can_clear_own_thread_solutions = PermissionValue.NO
    moderators_group.save()
...
def test_check_clear_thread_solution_permission_passes_for_category_moderator_without_permission_for_own_thread(
    ...
    members_group.can_clear_own_thread_solutions = PermissionValue.NO
    members_group.save()
...
def test_check_clear_thread_solution_permission_fails_for_user_with_never_permission_for_own_thread(
    thread_factory,
    thread_reply_factory,
    user_permissions_factory,
    user,
    ...
    members_group.can_clear_own_thread_solutions = PermissionValue.NEVER
    members_group.save()
...
def test_check_clear_thread_solution_permission_fails_for_anonymous_user_without_permission_for_other_user_thread(
    ...
    guests_group.can_clear_own_thread_solutions = PermissionValue.NO
    guests_group.save()
