...
@pytest.mark.asyncio
async def test_default_template_context_is_created_from_request_mock(request_mock):
...
@pytest.mark.asyncio
@patch("misago.template.context.partial", return_value=True)
async def test_final_template_context_includes_default_context(patch, request_mock):
