...
def test_thread_post_edit_hide_view_returns_error_404_if_thread_doesnt_exist(
    user_client,
):
    response = user_client.get(
        reverse(
...
def test_thread_post_edit_hide_view_returns_error_404_if_user_cant_see_thread_category(
    thread_reply_factory, user_client, members_group, user, thread
):
...
def test_thread_post_edit_hide_view_returns_error_404_if_user_cant_browse_thread_category(
    thread_reply_factory, user_client, members_group, user, thread
):
    CategoryGroupPermission.objects.filter(
        group=members_group,
...
def test_thread_post_edit_hide_view_returns_error_404_if_user_cant_see_thread(
...
def test_thread_post_edit_hide_view_returns_error_404_if_thread_post_doesnt_exist(
    user_client, thread
):
    response = user_client.get(
        reverse(
...
def test_thread_post_edit_hide_view_returns_error_404_if_thread_post_belongs_to_other_thread(
...
def test_thread_post_edit_hide_view_returns_error_404_if_user_cant_see_thread_post(
    thread_reply_factory, user_client, user, thread
):
...
def test_thread_post_edit_hide_view_returns_error_403_if_user_cant_see_thread_post_contents(
    thread_reply_factory, user_client, user, thread
):
...
def test_thread_post_edit_hide_view_returns_error_403_if_user_cant_see_other_users_post_edits_history(
    thread_reply_factory, user_client, members_group, user, thread
):
...
def test_thread_post_edit_hide_view_returns_error_403_if_user_can_see_other_users_post_edits_count_only(
    thread_reply_factory, user_client, members_group, user, thread
):
...
def test_thread_post_edit_hide_view_returns_error_404_if_post_is_in_thread(
