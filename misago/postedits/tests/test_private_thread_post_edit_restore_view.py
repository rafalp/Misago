...
def test_private_thread_post_edit_restore_view_returns_error_404_if_thread_post_doesnt_exist(
...
def test_private_thread_post_edit_restore_view_returns_error_404_if_thread_post_belongs_to_other_thread(
...
def test_private_thread_post_edit_restore_view_returns_error_403_if_user_cant_see_other_users_post_edits_history(
...
def test_private_thread_post_edit_restore_view_returns_error_403_if_user_can_see_other_users_post_edits_count_only(
    thread_reply_factory, user_client, members_group, user, other_user_private_thread
):
...
def test_private_thread_post_edit_restore_view_returns_error_404_if_post_is_in_thread(
