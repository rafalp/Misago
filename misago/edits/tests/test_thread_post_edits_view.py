...
def test_thread_post_edits_view_returns_error_404_if_thread_post_doesnt_exist(
    user_client, thread
):
    response = user_client.get(
        reverse(
...
def test_thread_post_edits_view_returns_error_403_if_user_cant_see_other_users_post_edits_history(
    thread_reply_factory, user_client, members_group, thread
):
...
def test_thread_post_edits_view_returns_error_403_if_user_can_see_other_users_post_edits_count_only(
    thread_reply_factory, user_client, members_group, thread
):
...
def test_thread_post_edits_view_returns_error_404_if_post_is_in_private_thread(
