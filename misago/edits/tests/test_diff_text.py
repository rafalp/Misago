...
def test_diff_text_diffs_different_content():
    ...
    assert result.lines == [
        {"marker": "-", "text": "Lorem ipsum"},
        {"marker": "+", "text": "Dolor met"},
    ]
...
def test_diff_text_diffs_removed_characters():
    ...
    assert result.lines == [
        {"marker": "-", "text": "Lorem ipsuum"},
        {"marker": "?", "changed": [], "added": [], "removed": [10]},
        {"marker": "+", "text": "Lorem ipsum"},
    ]
    assert result.added == 1
    assert result.removed == 1
...
def test_diff_text_diffs_added_characters():
    ...
    assert result.lines == [
        {"marker": "-", "text": "Lorem ipum"},
        {"marker": "+", "text": "Lorem ipsum"},
        {"marker": "?", "changed": [], "added": [8], "removed": []},
    ]
    assert result.added == 1
    assert result.removed == 1
...
def test_diff_text_diffs_changed_characters():
    ...
    assert result.lines == [
        {"marker": "-", "text": "Lorem iplum"},
        {"marker": "?", "changed": [8], "added": [], "removed": []},
        {"marker": "+", "text": "Lorem ipsum"},
        {"marker": "?", "changed": [8], "added": [], "removed": []},
    ]
    assert result.added == 1
