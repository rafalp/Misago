...
def test_private_thread_post_edit_delete_view_shows_error_403_if_post_edit_cant_be_deleted(
...
def test_private_thread_post_edit_delete_view_returns_error_403_if_user_has_no_private_threads_permission(
...
def test_private_thread_post_edit_delete_view_returns_error_404_if_thread_doesnt_exist(
    user_client,
):
    response = user_client.get(
        reverse(
...
def test_private_thread_post_edit_delete_view_returns_error_404_if_user_cant_see_thread(
...
def test_private_thread_post_edit_delete_view_returns_error_404_if_thread_post_doesnt_exist(
...
def test_private_thread_post_edit_delete_view_returns_error_404_if_thread_post_belongs_to_other_thread(
...
def test_private_thread_post_edit_delete_view_returns_error_404_if_user_cant_see_thread_post(
    thread_reply_factory, user_client, user, other_user_private_thread
):
...
def test_private_thread_post_edit_delete_view_returns_error_403_if_user_cant_see_thread_post_contents(
    thread_reply_factory, user_client, user, other_user_private_thread
):
...
def test_private_thread_post_edit_delete_view_returns_error_403_if_user_cant_see_other_users_post_edits_history(
    thread_reply_factory, user_client, members_group, user, other_user_private_thread
):
...
def test_private_thread_post_edit_delete_view_returns_error_403_if_user_can_see_other_users_post_edits_count_only(
    thread_reply_factory, user_client, members_group, user, other_user_private_thread
):
...
def test_private_thread_post_edit_delete_view_returns_error_404_if_post_is_in_thread(
