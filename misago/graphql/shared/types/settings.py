...
settings_type.set_alias("enableSiteWizard", "enable_site_wizard")
...
settings_type.set_alias("passwordMaxLength", "password_max_length")
settings_type.set_alias("postMinLength", "post_min_length")
