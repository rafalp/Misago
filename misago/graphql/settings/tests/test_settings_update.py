...
@pytest.mark.asyncio
async def test_admin_settings_update_mutation_changes_all_settings(query_admin_api):
    query = create_query(
        """
            bulkActionLimit
            enableSiteWizard
...
@pytest.mark.asyncio
async def test_admin_settings_update_mutation_changes_some_settings(query_admin_api):
    query = create_query(
        """
            bulkActionLimit
            forumIndexThreads
...
@pytest.mark.asyncio
async def test_admin_settings_update_mutation_invalidates_settings_cache(
    query_admin_api,
):
...
@pytest.mark.asyncio
async def test_admin_settings_update_mutation_validates_settings_values(
    query_admin_api,
):
...
@pytest.mark.asyncio
async def test_admin_settings_update_mutation_validates_posts_pagination_bounds(
    query_admin_api,
):
...
@pytest.mark.asyncio
async def test_admin_settings_update_mutation_validates_thread_title_bounds(
    query_admin_api,
):
...
@pytest.mark.asyncio
async def test_admin_settings_update_mutation_validates_username_bounds(
    query_admin_api,
):
...
@pytest.mark.asyncio
async def test_adin_settings_update_mutation_requires_admin_auth(query_admin_api):
