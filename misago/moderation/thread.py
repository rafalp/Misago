...
class PinEverywhereThreadModerationAction(ThreadModerationAction):
    ...
    def execute(self) -> ModerationResult:
        ...
        return ModerationResult(updated_items=[thread], thread_update=[thread_update])
...
class MergeThreadModerationAction(FormMixin, ThreadModerationAction):
    ...
    def form_valid(self, form) -> ModerationResult:
        ...
        return self.get_result(final_thread, other_thread)
    ...
    def get_result(
        self, final_thread: Thread, other_thread: Thread
    ) -> ModerationResult:
        refresh = False
        ...
        return ModerationResult(
            updated_items=[final_thread],
            deleted_items=[other_thread],
            refresh=refresh,
...
class DeleteThreadModerationAction(ConfirmMixin, ThreadModerationAction):
    ...
    def confirmed(self) -> ModerationResult:
        ...
        return ModerationResult(deleted_items=[thread])
