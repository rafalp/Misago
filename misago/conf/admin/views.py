...
class ChangeOAuthSettingsView(ChangeSettingsView):
    form_class = ChangeOAuthSettingsForm
    template_name = "misago/admin/conf/oauth_settings.html"
