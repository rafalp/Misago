...
def test_dict_input_widget_value_from_datadict_returns_empty_list():
    widget = DictInput()
    assert widget.value_from_datadict(QueryDict(""), None, "name") == []


def test_dict_input_widget_value_from_datadict_returns_list_of_tuples():
    widget = DictInput()
...
def test_dict_input_widget_value_from_datadict_skips_invalid_keys():
    widget = DictInput()
    assert widget.value_from_datadict(QueryDict("name=A&name[]=B"), None, "name") == []
