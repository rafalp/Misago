...
def test_render_tokens_to_markup_renders_blockquote(parse_to_tokens):
    tokens = parse_to_tokens("> hello")
    assert render_tokens_to_markup(tokens) == "hello"
...
def test_render_tokens_to_markup_renders_quote_bbcode_with_user(parse_to_tokens):
    tokens = parse_to_tokens("[quote=User, post: 123]hello[/quote]")
    assert render_tokens_to_markup(tokens) == "User, #123:\nhello"


def test_render_tokens_to_markup_renders_spoiler_bbcode(parse_to_tokens):
    tokens = parse_to_tokens("[spoiler]hello[/spoiler]")
    assert render_tokens_to_markup(tokens) == "hello"


def test_render_tokens_to_markup_renders_spoiler_bbcode_with_info(parse_to_tokens):
    tokens = parse_to_tokens("[spoiler=info]hello[/spoiler]")
    assert render_tokens_to_markup(tokens) == "info:\nhello"


def test_render_tokens_to_markup_renders_ordered_list(parse_to_tokens):
    tokens = parse_to_tokens("2. lorem\n3. ipsum")
    assert render_tokens_to_markup(tokens) == "2. lorem\n3. ipsum"


def test_render_tokens_to_markup_renders_bullet_list(parse_to_tokens):
    tokens = parse_to_tokens("- lorem\n- ipsum")
    assert render_tokens_to_markup(tokens) == "- lorem\n- ipsum"


def test_render_tokens_to_markup_renders_ordered_list_with_nested_ordered_list(
    parse_to_tokens,
):
    tokens = parse_to_tokens("2. lorem\n   1. ipsum\n   2. dolor\n3. met")
    assert render_tokens_to_markup(tokens) == (
...
def test_render_tokens_to_markup_renders_ordered_list_with_nested_bullet_list(
    parse_to_tokens,
):
    tokens = parse_to_tokens("2. lorem\n   - ipsum\n   - dolor\n3. met")
    assert render_tokens_to_markup(tokens) == (
...
def test_render_tokens_to_markup_renders_bullet_list_with_nested_ordered_list(
    parse_to_tokens,
):
    tokens = parse_to_tokens("- lorem\n  1. ipsum\n  2. dolor\n- met")
    assert render_tokens_to_markup(tokens) == (
...
def test_render_tokens_to_markup_renders_bullet_list_with_nested_bullet_list(
    parse_to_tokens,
):
    tokens = parse_to_tokens("- lorem\n  - ipsum\n  - dolor\n- met")
    assert render_tokens_to_markup(tokens) == (
...
def test_render_tokens_to_markup_renders_table(parse_to_tokens):
    tokens = parse_to_tokens(
        "| col1 | col2 | col3|\n| - | - | - |\n| cell1 | cell2 | cell3 |"
    )
...
def test_render_tokens_to_markup_renders_linkified_link(parse_to_tokens):
    tokens = parse_to_tokens("Hello, https://example.com")
    assert render_tokens_to_markup(tokens) == "Hello, https://example.com"


def test_render_tokens_to_markup_renders_autolink(parse_to_tokens):
    tokens = parse_to_tokens("Hello, <https://example.com>")
    assert render_tokens_to_markup(tokens) == "Hello, https://example.com"


def test_render_tokens_to_markup_renders_link(parse_to_tokens):
    tokens = parse_to_tokens("Hello, [Link](https://example.com)")
    assert render_tokens_to_markup(tokens) == "Hello, https://example.com (Link)"


def test_render_tokens_to_markup_renders_url_bbcode(parse_to_tokens):
    tokens = parse_to_tokens("Hello, [url]https://example.com[/url]")
    assert render_tokens_to_markup(tokens) == "Hello, https://example.com"


def test_render_tokens_to_markup_renders_url_bbcode_with_text(parse_to_tokens):
    tokens = parse_to_tokens("Hello, [url=https://example.com]Link[/url]")
    assert render_tokens_to_markup(tokens) == "Hello, https://example.com (Link)"


def test_render_tokens_to_markup_renders_image(parse_to_tokens):
...
def test_render_tokens_to_markup_renders_image_with_title(parse_to_tokens):
...
def test_render_tokens_to_markup_renders_image_bbcode(parse_to_tokens):
...
def test_render_tokens_to_markup_renders_image_bbcode_with_alt(parse_to_tokens):
...
def test_render_tokens_to_markup_renders_youtube_video(parse_to_tokens):
...
def test_render_tokens_to_markup_renders_mention(parse_to_tokens, user):
    tokens = parse_to_tokens(f"Hello, @{user.username}")
    assert render_tokens_to_markup(tokens) == f"Hello, @{user.username}"


def test_render_tokens_to_markup_renders_soft_linebreak(parse_to_tokens):
    tokens = parse_to_tokens("hello\nworld")
    assert render_tokens_to_markup(tokens) == "hello\nworld"
