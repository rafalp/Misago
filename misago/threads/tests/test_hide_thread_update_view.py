...
def test_hide_thread_update_view_returns_403_error_for_anonymous_user(
...
def test_hide_thread_update_view_returns_403_error_for_user(
...
def test_hide_thread_update_view_checks_category_permission(
    user_client, thread, thread_update
):
...
def test_hide_thread_update_view_checks_thread_permission(
    user_client, thread, thread_update
):
...
def test_hide_thread_update_view_hides_update_for_category_moderator(
...
def test_hide_thread_update_view_hides_update_for_global_moderator(
...
def test_hide_thread_update_view_returns_redirect_to_next_url(
    moderator_client, thread, thread_update
):
    next_url = reverse(
...
def test_hide_thread_update_view_returns_redirect_to_thread_for_invalid_next_url(
    moderator_client, thread, thread_update
):
    response = moderator_client.post(
        reverse(
...
def test_hide_thread_update_view_returns_403_error_for_anonymous_user_in_htmx(
    client, thread, thread_update
):
    response = client.post(
        reverse(
...
def test_hide_thread_update_view_returns_403_error_for_user_in_htmx(
    user_client, thread, thread_update
):
    response = user_client.post(
        reverse(
...
def test_hide_thread_update_view_checks_category_permission_in_htmx(
    user_client, thread, thread_update
):
    CategoryGroupPermission.objects.filter(
        permission=CategoryPermission.BROWSE
...
def test_hide_thread_update_view_checks_thread_permission_in_htmx(
    user_client, thread, thread_update
):
    thread.is_hidden = True
    thread.save()
...
def test_hide_thread_update_view_hides_update_for_category_moderator_in_htmx(
    user_client, user, default_category, thread, thread_update
):
    Moderator.objects.create(
        categories=[default_category.id],
...
def test_hide_thread_update_view_hides_update_for_global_moderator_in_htmx(
    moderator_client, thread, thread_update
):
    response = moderator_client.post(
        reverse(
