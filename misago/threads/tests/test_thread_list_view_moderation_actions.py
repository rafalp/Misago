...
@override_dynamic_settings(index_view="categories")
def test_thread_list_view_require_reply_approval_moderation_action_requires_threads_reply_approval(
    thread_factory, moderator_client, default_category
):
    thread = thread_factory(default_category)
...
@override_dynamic_settings(index_view="categories")
def test_thread_list_view_require_reply_approval_moderation_action_validates_threads(
    thread_factory, moderator_client, default_category
):
...
@override_dynamic_settings(index_view="categories")
def test_thread_list_view_remove_reply_approval_moderation_action_removes_threads_reply_approval(
    thread_factory, moderator_client, default_category
):
    thread = thread_factory(default_category, require_reply_approval=True)
...
@override_dynamic_settings(index_view="categories")
def test_thread_list_view_remove_reply_approval_moderation_action_validates_threads(
    thread_factory, moderator_client, default_category
):
    thread = thread_factory(default_category)
...
@override_dynamic_settings(index_view="categories")
def test_thread_list_view_move_moderation_action_moves_threads(
    thread_factory,
    moderator_client,
    moderators_group,
    default_category,
...
@override_dynamic_settings(index_view="categories")
def test_thread_list_view_move_moderation_action_validates_other_category_choices_exist(
    thread_factory,
    moderator_client,
    default_category,
    mock_synchronize_categories,
...
@override_dynamic_settings(index_view="categories")
def test_thread_list_view_move_moderation_action_requires_category(
    thread_factory,
    moderator_client,
    moderators_group,
    default_category,
...
@override_dynamic_settings(index_view="categories")
def test_thread_list_view_move_moderation_action_validates_category_value(
    thread_factory,
    moderator_client,
    moderators_group,
    default_category,
...
@override_dynamic_settings(index_view="categories")
def test_thread_list_view_move_moderation_action_validates_category_type(
    thread_factory,
    moderator_client,
    moderators_group,
    default_category,
...
@override_dynamic_settings(index_view="categories")
def test_thread_list_view_move_moderation_action_validates_category_is_new(
    thread_factory,
    moderator_client,
    moderators_group,
    default_category,
...
@override_dynamic_settings(index_view="categories")
def test_thread_list_view_merge_moderation_action_merges_threads(
    moderator_client,
    default_category,
    thread,
    other_thread,
...
@override_dynamic_settings(index_view="categories")
def test_thread_list_view_merge_moderation_action_merges_threads_without_conflicts(
...
@override_dynamic_settings(index_view="categories")
def test_thread_list_view_merge_moderation_action_merges_threads_with_conflicts(
    thread_reply_factory,
    poll_factory,
    moderator_client,
    default_category,
...
@override_dynamic_settings(index_view="categories")
def test_thread_list_view_merge_moderation_action_merges_threads_with_moderation_options(
    moderator_client,
    default_category,
    thread,
    other_thread,
...
@override_dynamic_settings(index_view="categories")
def test_thread_list_view_merge_moderation_action_requires_thread_title(
    moderator_client,
    default_category,
    thread,
    other_thread,
...
@override_dynamic_settings(index_view="categories")
def test_thread_list_view_merge_moderation_action_validates_thread_title(
    moderator_client,
    default_category,
    thread,
    other_thread,
...
@override_dynamic_settings(index_view="categories")
def test_thread_list_view_merge_moderation_action_requires_conflict_resolution(
    thread_reply_factory,
    moderator_client,
    default_category,
    thread,
...
@override_dynamic_settings(index_view="categories")
def test_thread_list_view_merge_moderation_action_validates_conflict_resolution(
    thread_reply_factory,
    moderator_client,
    default_category,
    thread,
