...
class GetThreadDetailViewPostsQuerysetHookAction(Protocol):
    """
    Misago function used to get a queryset used to get posts displayed
    on the thread detail view.
...
class GetThreadDetailViewPostsQuerysetHookFilter(Protocol):
    """
...
class GetThreadDetailViewPostsQuerysetHook(
    FilterHook[
        GetThreadDetailViewPostsQuerysetHookAction,
        GetThreadDetailViewPostsQuerysetHookFilter,
    ]
):
    """
    This hook wraps the standard function that Misago uses to get a queryset
    with posts to display on the thread detail view.
...
get_thread_detail_view_posts_queryset_hook = GetThreadDetailViewPostsQuerysetHook()
